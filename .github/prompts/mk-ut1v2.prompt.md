...
Analyze the selected Java class and generate focused unit tests that thoroughly validate its behavior.
...
Testing framework: ${input:framework:Which framework? (junit5)}
Mock framework: ${input:framework:Which framework? (mockito)}
